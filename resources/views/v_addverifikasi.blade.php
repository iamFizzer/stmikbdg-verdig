    ...
    <div class="row">
        ...
        <div class ="row">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    <label>NIM</label>
                    <input type="text" id="nim" name="nim" value="{{session('profile')['nim'] ?? '-'}}"class="form-control" readonly >
                </div>
                <div class="form-group">
                    <label>Nama</label>
                    <input type="text" id="nama" name="nama" value="{{session('profile')['nama'] ?? '-'}}" class="form-control" readonly>
                </div>
                <div class="form-group">
